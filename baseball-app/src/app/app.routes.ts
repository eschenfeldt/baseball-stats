...
export const BASEBALL_ROUTES = <const>{
    ...
    GAMES: 'games',
    GAME: 'game/:gameId',
    GAME_TAB: 'game/:gameId/:tab',
    GAME_BOX_SCORE: 'game/:gameId/:tab/:boxScoreOption',
    TEAMS: 'teams',
    TEAM: 'team/:teamId',
    PARKS: 'parks',
    PARK: 'park/:parkId',
...
export const routes: Routes = [
    ...
    { path: BASEBALL_ROUTES.GAME_TAB, component: GameComponent },
    { path: BASEBALL_ROUTES.GAME_BOX_SCORE, component: GameComponent },
