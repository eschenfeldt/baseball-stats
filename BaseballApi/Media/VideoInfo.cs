...
namespace BaseballApi.Video;

public class VideoInfo
{
    [JsonPropertyName("streams")]
    public required List<VideoStreamInfo> Streams { get; set; }

    [JsonPropertyName("format")]
    public required VideoFormatInfo Format { get; set; }
}
...
public class FormatTags
{
    ...
    [JsonPropertyName("com.apple.quicktime.location.accuracy.horizontal")]
    public string? LocationAccuracyHorizontal { get; set; }

    [JsonPropertyName("com.apple.quicktime.location.ISO6709")]
    public string? LocationISO6709 { get; set; }

    [JsonPropertyName("com.apple.quicktime.make")]
    public string? Make { get; set; }

    [JsonPropertyName("com.apple.quicktime.model")]
    public string? Model { get; set; }

    [JsonPropertyName("com.apple.quicktime.software")]
    public string? Software { get; set; }

    [JsonPropertyName("com.apple.quicktime.creationdate")]
